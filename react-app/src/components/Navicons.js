export const menuIcon = (
  <svg
    ...
    role="presentation"
    focusable="false"
    styles="display: block; fill: none; height: 16px; width: 16px; stroke: currentcolor; strokeWidth: 3; overflow: visible;"
    width="32"
    height="32"
  >
...
export const closeButton = (
  <svg
    ...
    height="32"
  >
    <path d="m6 6 20 20" stroke="#222222" fill="none" strokeWidth="3px"></path>
    <path d="m26 6-20 20" stroke="#222222" fill="none" strokeWidth="3px"></path>
  </svg>
);
...
export const littleStar = (
  <svg viewBox="-5 -10 60 60" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" width="20"  height="" ><path d="M15.094 1.579l-4.124 8.885-9.86 1.27a1 1 0 0 0-.542 1.736l7.293 6.565-1.965 9.852a1 1 0 0 0 1.483 1.061L16 25.951l8.625 4.997a1 1 0 0 0 1.482-1.06l-1.965-9.853 7.293-6.565a1 1 0 0 0-.541-1.735l-9.86-1.271-4.127-8.885a1 1 0 0 0-1.814 0z" fill-rule="evenodd" fill="#222222"></path></svg>
)
