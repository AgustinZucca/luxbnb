...
class CreateSpotForm(FlaskForm):
    ...
    city = StringField('City', validators=[DataRequired(message='Spot needs a city'), Length(max=50, message='City cannot be longer than 50 characters.')])
    ...
    name = StringField('Name', validators=[DataRequired(message='Spot needs a name'), Length(max=50, message='Name cannot be longer than 50 characters.')])
